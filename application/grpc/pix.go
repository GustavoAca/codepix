...
type PixGrcpService struct {
	PixUseCase usecase.PixUseCase
	pb.UnimplementedPixServiceServer
}

func (p *PixGrcpService) RegisterPixKey(ctx context.Context, in *pb.PixKeyRegistration) (*pb.PixKeyCreatedResult, error) {
...
func (p *PixGrcpService) Find(ctx context.Context, in *pb.PixKey) (*pb.PixKeyInfo, error) {
...
func NewPixGrpcService(usecase usecase.PixUseCase) *PixGrcpService {
	return &PixGrcpService{
		PixUseCase: usecase,
	}
}
